...
func (mc *BitmexClient) prepareMainOrder(ctx context.Context, d *models.Describer) (*PreparedOrder, error) {
	...
	instrument, err := mc.GetInstrument(ctx, d.Symbol)
	if err != nil {
...
func (mc *BitmexClient) prepareStopLossOrder(ctx context.Context, d *models.Describer, od *OrderData) *PreparedOrder {
	var po PreparedOrder
	var side SideType
	if d.Side == types.SIDE_L {
		side = SideTypeSell
...
func (mc *BitmexClient) prepareTakeProfitOrder(ctx context.Context, d *models.Describer, od *OrderData) *PreparedOrder {
	var po PreparedOrder
	var side SideType
	if d.Side == types.SIDE_L {
		side = SideTypeSell
