...
func (b *Bot) handleFilledBitmex(ctx context.Context, od swagger.OrderData) {
...
func (b *Bot) handleNewFilledBitmex(ctx context.Context, t *models.Trade, od swagger.OrderData) {
	// update trade state
