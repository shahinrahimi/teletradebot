...
func (b *Bot) handleExecuteBinance(ctx context.Context, t *models.Trade, userID int64, ex exchange.Exchange) {
	...
	go b.scheduleOrderReplacementBinance(ctx, interpreter, t, ex)
