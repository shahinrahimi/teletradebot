...
*CampaignApi* | [**CampaignGetAllCampaigns**](docs/CampaignApi.md#campaigngetallcampaigns) | **Get** /campaign/all | Returns all campaigns data
...
*FormSubmissionApi* | [**FormSubmissionGet**](docs/FormSubmissionApi.md#formsubmissionget) | **Get** /formSubmission | Returns whether the provided form type has been submitted by the user
*FormSubmissionApi* | [**FormSubmissionNew**](docs/FormSubmissionApi.md#formsubmissionnew) | **Post** /formSubmission | Create a new form submission
...
*UserApi* | [**UserCreateIndependentSubaccount**](docs/UserApi.md#usercreateindependentsubaccount) | **Post** /user/createIndependentSubaccount | Creates a new independant sub-account.
...
*UserApi* | [**UserRequestWithdrawal**](docs/UserApi.md#userrequestwithdrawal) | **Post** /user/requestWithdrawal | Request a withdrawal to an external wallet or separate BitMEX account.
...
*UserApi* | [**UserWalletTransfer**](docs/UserApi.md#userwallettransfer) | **Post** /user/walletTransfer | Execute a transfer to a linked account.
