...
/*
CampaignApiService Returns all campaigns data
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []XAny
*/
func (a *CampaignApiService) CampaignGetAllCampaigns(ctx context.Context) ([]XAny, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/campaign/all"
