 ...
 * @param optional nil or *AddressApiAddressNewOpts - Optional Parameters:
     * @param "Currency" (optional.String) -  Currency of the address. Options: &#x60;XBt&#x60;, &#x60;USDt&#x60;
...
func (a *AddressApiService) AddressNew(ctx context.Context, network string, address string, name string, localVarOptionals *AddressApiAddressNewOpts) (Address, *http.Response, error) {
	var (
