...
/*
UserApiService Creates a new independant sub-account.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param email
  - @param accountName
...
@return interface{}
*/
func (a *UserApiService) UserCreateIndependentSubaccount(ctx context.Context, email string, accountName string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/user/createIndependentSubaccount"
...
func (a *UserApiService) UserGetMargins(ctx context.Context, localVarOptionals *UserApiUserGetMarginOpts) ([]Margin, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
UserApiService Request a withdrawal to an external wallet or separate BitMEX account.
 ...
 * @param network The &#x60;network&#x60; parameter is used to indicate which blockchain you would like to withdraw from. The acceptable value in the &#x60;network&#x60; parameter for each currency can be found from &#x60;networks.asset&#x60; from &#x60;GET /api/v1/wallet/assets&#x60;.
 * @param amount Amount of withdrawal currency.
 * @param optional nil or *UserApiUserRequestWithdrawalOpts - Optional Parameters:
     * @param "OtpToken" (optional.String) -  2FA token. Required for all external withdrawals unless the destination is a saved address with &#x60;skip2FA&#x60; configured.
     * @param "Address" (optional.String) -  Destination Address. One of &#x60;address&#x60;, &#x60;addressId&#x60;, &#x60;targetUserId&#x60; has to be specified.
     * @param "Memo" (optional.String) -  Destination Memo. If &#x60;address&#x60;, is specified, destination Memo can also be specified. If given an &#x60;addressId&#x60; or &#x60;address&#x60; matching a saved address, the destination memo from the saved address will be used.
     * @param "AddressId" (optional.Float64) -  ID of the Destination Address. One of &#x60;address&#x60;, &#x60;addressId&#x60;, &#x60;targetUserId&#x60; has to be specified.
     * @param "TargetUserId" (optional.Float64) -  ID of a linked BitMEX account. One of &#x60;address&#x60;, &#x60;addressId&#x60;, &#x60;targetUserId&#x60; has to be specified.
...
/*
UserApiService Execute a transfer to a linked account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
