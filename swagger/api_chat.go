 ...
 * @param optional nil or *ChatApiChatGetOpts - Optional Parameters:
     ...
     * @param "ChannelID" (optional.Float64) -  Channel id. GET /chat/channels for ids. Global English by default
...
/*
ChatApiService Get pinned message for a channel.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param channelID

@return PinnedMessage
*/
func (a *ChatApiService) ChatGetPinnedMessage(ctx context.Context, channelID float64) (PinnedMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PinnedMessage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/chat/pinned"
