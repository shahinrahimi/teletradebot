 ...
 * @param optional nil or *OrderApiOrderAmendOpts - Optional Parameters:
...
type OrderApiOrderAmendOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OrderApiOrderCancelAllOpts - Optional Parameters:
     * @param "TargetAccountIds" (optional.String) -  AccountIds to cancel all orders, must be a paired account with main user. Also accepts wildcard, [*], this will cancel all orders for all accounts. the authenticated user has order write permissions for.
...
type OrderApiOrderCancelAllOpts struct {
	TargetAccountIds optional.String
...
func (a *OrderApiService) OrderCancelAll(ctx context.Context, localVarOptionals *OrderApiOrderCancelAllOpts) ([]Order, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.TargetAccountIds.IsSet() {
		localVarFormParams.Add("targetAccountIds", parameterToString(localVarOptionals.TargetAccountIds.Value(), ""))
	}
 ...
 * @param optional nil or *OrderApiOrderClosePositionOpts - Optional Parameters:
     * @param "Price" (optional.Float64) -  Optional limit price.

@return Order
*/

type OrderApiOrderClosePositionOpts struct {
	Price optional.Float64
}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OrderApiOrderGetOrdersOpts - Optional Parameters:
...
type OrderApiOrderGetOrdersOpts struct {
	Symbol    optional.String
	Filter    optional.String
 ...
 * @param optional nil or *OrderApiOrderNewOpts - Optional Parameters:
     ...
     * @param "PegOffsetValue" (optional.Float64) -  Optional trailing offset from the current price for &#39;Stop&#39;, &#39;StopLimit&#39;, &#39;MarketIfTouched&#39;, and &#39;LimitIfTouched&#39; orders; use a negative offset for stop-sell orders and buy-if-touched orders. Optional offset from the peg price for &#39;Pegged&#39; orders.
     * @param "PegPriceType" (optional.String) -  Optional peg price type. Valid options: MarketPeg, PrimaryPeg, TrailingStopPeg.
     * @param "OrdType" (optional.String) -  Order type. Valid options: Market, Limit, Stop, StopLimit, MarketIfTouched, LimitIfTouched, Pegged. Defaults to &#39;Limit&#39; when &#x60;price&#x60; is specified. Defaults to &#39;Stop&#39; when &#x60;stopPx&#x60; is specified. Defaults to &#39;StopLimit&#39; when &#x60;price&#x60; and &#x60;stopPx&#x60; are specified.
     * @param "TimeInForce" (optional.String) -  Time in force. Valid options: Day, GoodTillCancel, ImmediateOrCancel, FillOrKill. Defaults to &#39;GoodTillCancel&#39; for &#39;Limit&#39;, &#39;StopLimit&#39;, and &#39;LimitIfTouched&#39; orders.
     ...
     * @param "ContingencyType" (optional.String) -  Optional contingency type for use with &#x60;clOrdLinkID&#x60;. Valid options: OneCancelsTheOther, OneTriggersTheOther.
