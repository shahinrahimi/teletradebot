 ...
 * @param optional nil or *PositionApiPositionIsolateMarginOpts - Optional Parameters:
     * @param "Enabled" (optional.Bool) -  True for isolated margin, false for cross margin.

@return Position
*/

type PositionApiPositionIsolateMarginOpts struct { 
 ...
 * @param optional nil or *PositionApiPositionTransferIsolatedMarginOpts - Optional Parameters:
     * @param "TargetAccountId" (optional.Float64) -  AccountId for the position that the margin would be transfered to, must be a paired account with main user.

@return Position
*/

type PositionApiPositionTransferIsolatedMarginOpts struct { 
...
func (a *PositionApiService) PositionTransferIsolatedMargin(ctx context.Context, symbol string, amount float32, localVarOptionals *PositionApiPositionTransferIsolatedMarginOpts) (Position, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.TargetAccountId.IsSet() {
		localVarFormParams.Add("targetAccountId", parameterToString(localVarOptionals.TargetAccountId.Value(), ""))
	}
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
 ...
 * @param optional nil or *PositionApiPositionUpdateLeverageOpts - Optional Parameters:
     * @param "TargetAccountId" (optional.Float64) -  AccountId for the position that the leverage would be changed on, must be a paired account with main user.

@return Position
*/

type PositionApiPositionUpdateLeverageOpts struct { 
	TargetAccountId optional.Float64
}

func (a *PositionApiService) PositionUpdateLeverage(ctx context.Context, symbol string, leverage float64, localVarOptionals *PositionApiPositionUpdateLeverageOpts) (Position, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *PositionApiPositionUpdateRiskLimitOpts - Optional Parameters:
     * @param "TargetAccountId" (optional.Float64) -  AccountId for the position that the risk limit would be updated on, must be a paired account with main user.

@return Position
*/

type PositionApiPositionUpdateRiskLimitOpts struct { 
	TargetAccountId optional.Float64
}
