...
/*
InstrumentApiService Get a summary of exchange statistics in USD.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *InstrumentApiInstrumentGetUsdVolumeOpts - Optional Parameters:
     * @param "Symbol" (optional.String) -  Filter by symbol.
     * @param "Columns" (optional.String) -  Array of column names to fetch.

@return []StatsUsdbySymbol
*/

type InstrumentApiInstrumentGetUsdVolumeOpts struct { 
	Symbol optional.String
	Columns optional.String
}
...
func (a *InstrumentApiService) InstrumentGetUsdVolume(ctx context.Context, localVarOptionals *InstrumentApiInstrumentGetUsdVolumeOpts) ([]StatsUsdbySymbol, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []StatsUsdbySymbol
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/instrument/usdVolume"
